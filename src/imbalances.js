    ...
    more: [
      {
        name: "Hanging pawns",
        planAgainst: [
          "Try to trade pieces, (remove key defenders of the hanging pawns), get to an endgame, where hanging pawns become easy targets ",
          "Blockade the pawns, later attacking them.",
        ],
        planWith: [
          "Avoid trading pieces ",
          "Try to build your position behind the hanging pawns",
          "Eventually, the idea is to advance one of the pawns to open the position and unleash an attack",
        ],
      },
    ],
  },
